...
"""
ID:          function.alter_blr.with_psql_stat
TITLE:       Alter function with psql stat
DESCRIPTION:
FBTEST:      functional.function.alter_blr_with_psql_stat
"""
        ...
        with con.cursor() as cur:
            try:
                ...
                for row in cur.fetchall():
                    cur.execute(f"alter function BLR_FUNC RETURNS INTEGER as '{row[0]}'")
                    con.commit()
