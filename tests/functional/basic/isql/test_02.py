...
CP943C_UNICODE, CHARACTER SET CP943C, PAD SPACE, 'COLL-VERSION=58.0.6.50', SYSTEM
...
GB18030_UNICODE, CHARACTER SET GB18030, PAD SPACE, 'COLL-VERSION=58.0.6.50', SYSTEM
GBK, CHARACTER SET GBK, PAD SPACE, SYSTEM
GBK_UNICODE, CHARACTER SET GBK, PAD SPACE, 'COLL-VERSION=58.0.6.50', SYSTEM
...
TIS620_UNICODE, CHARACTER SET TIS620, PAD SPACE, 'COLL-VERSION=58.0.6.50', SYSTEM
UCS_BASIC, CHARACTER SET UTF8, PAD SPACE, SYSTEM
UNICODE, CHARACTER SET UTF8, PAD SPACE, 'COLL-VERSION=58.0.6.50', SYSTEM
UNICODE_CI, CHARACTER SET UTF8, FROM EXTERNAL ('UNICODE'), PAD SPACE, CASE INSENSITIVE, 'COLL-VERSION=58.0.6.50', SYSTEM
UNICODE_CI_AI, CHARACTER SET UTF8, FROM EXTERNAL ('UNICODE'), PAD SPACE, CASE INSENSITIVE, ACCENT INSENSITIVE, 'COLL-VERSION=58.0.6.50', SYSTEM
...
Generators:
Generator RDB$BACKUP_HISTORY, current value: 0, initial value: 0, increment: 0
...
Generator RDB$FUNCTIONS, current value: 0, initial value: 0, increment: 0
...
Generator RDB$PROCEDURES, current value: 0, initial value: 0, increment: 0
Generator RDB$SECURITY_CLASS, current value: 427, initial value: 0, increment: 0
Generator RDB$TRIGGER_NAME, current value: 0, initial value: 0, increment: 0
Generator SQL$DEFAULT, current value: 51, initial value: 0, increment: 0
"""
...
expected_stdout_3 = """
    ...
    BS_BA, CHARACTER SET WIN1250, PAD SPACE, SYSTEM
    CP943C, CHARACTER SET CP943C, PAD SPACE, SYSTEM
    CP943C_UNICODE, CHARACTER SET CP943C, PAD SPACE, 'COLL-VERSION=153.88;ICU-VERSION=63.1', SYSTEM
    CS_CZ, CHARACTER SET ISO8859_2, PAD SPACE, SYSTEM
    CYRL, CHARACTER SET CYRL, PAD SPACE, SYSTEM
    DA_DA, CHARACTER SET ISO8859_1, PAD SPACE, SYSTEM
    DB_CSY, CHARACTER SET DOS852, PAD SPACE, SYSTEM
    ...
    FR_FR_CI_AI, CHARACTER SET ISO8859_1, FROM EXTERNAL ('FR_FR'), PAD SPACE, CASE INSENSITIVE, ACCENT INSENSITIVE, 'SPECIALS-FIRST=1', SYSTEM
    GB18030, CHARACTER SET GB18030, PAD SPACE, SYSTEM
    GB18030_UNICODE, CHARACTER SET GB18030, PAD SPACE, 'COLL-VERSION=153.88;ICU-VERSION=63.1', SYSTEM
    GBK, CHARACTER SET GBK, PAD SPACE, SYSTEM
    GBK_UNICODE, CHARACTER SET GBK, PAD SPACE, 'COLL-VERSION=153.88;ICU-VERSION=63.1', SYSTEM
    GB_2312, CHARACTER SET GB_2312, PAD SPACE, SYSTEM
    ISO8859_1, CHARACTER SET ISO8859_1, PAD SPACE, SYSTEM
    ISO8859_13, CHARACTER SET ISO8859_13, PAD SPACE, SYSTEM
    ISO8859_2, CHARACTER SET ISO8859_2, PAD SPACE, SYSTEM
    ...
    SV_SV, CHARACTER SET ISO8859_1, PAD SPACE, SYSTEM
    TIS620, CHARACTER SET TIS620, PAD SPACE, SYSTEM
    TIS620_UNICODE, CHARACTER SET TIS620, PAD SPACE, 'COLL-VERSION=153.88;ICU-VERSION=63.1', SYSTEM
    UCS_BASIC, CHARACTER SET UTF8, PAD SPACE, SYSTEM
    UNICODE, CHARACTER SET UTF8, PAD SPACE, 'COLL-VERSION=153.88;ICU-VERSION=63.1', SYSTEM
    UNICODE_CI, CHARACTER SET UTF8, FROM EXTERNAL ('UNICODE'), PAD SPACE, CASE INSENSITIVE, 'COLL-VERSION=153.88;ICU-VERSION=63.1', SYSTEM
    UNICODE_CI_AI, CHARACTER SET UTF8, FROM EXTERNAL ('UNICODE'), PAD SPACE, CASE INSENSITIVE, ACCENT INSENSITIVE, 'COLL-VERSION=153.88;ICU-VERSION=63.1', SYSTEM
    UNICODE_FSS, CHARACTER SET UNICODE_FSS, PAD SPACE, SYSTEM
    UTF8, CHARACTER SET UTF8, PAD SPACE, SYSTEM
    WIN1250, CHARACTER SET WIN1250, PAD SPACE, SYSTEM
    WIN1251, CHARACTER SET WIN1251, PAD SPACE, SYSTEM
