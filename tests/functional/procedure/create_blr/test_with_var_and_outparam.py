...
"""
ID:          procedure.create_blr.with_var_outparam
TITLE:       Create procedure with variables and output parameters
DESCRIPTION:
FBTEST:      functional.procedure.create_blr_with_var_outparam
"""
    ...
    with act.db.connect() as con:
        with con.cursor() as cur:
            ...
            for row in cur.fetchall():
                cur.execute(f"create procedure BLR_PROC RETURNS(p1 SMALLINT, p2 INTEGER, p3 FLOAT, p4 DOUBLE PRECISION, p5 DECIMAL(9,3), p6 NUMERIC(10,4), p7 DATE, p8 TIME, p9 TIMESTAMP, p10 CHAR(40), p11 VARCHAR(60), p12 NCHAR(70)) as '{row[0]}'")
                con.commit()
