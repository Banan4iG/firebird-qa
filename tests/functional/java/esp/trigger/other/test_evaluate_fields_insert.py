...
"""
ID:          java.esp.trigger.other.evaluate-fields-insert
TITLE:       Skip evaluating of some fields on insert
DESCRIPTION: 
FBTEST:      functional.java.esp.trigger.other.evaluate_fields_insert
"""
...
ACTIVE
AFTER INSERT
external name 'esp.TestTrigger.evaluate_all_fields_insert()'
engine JAVA;
commit;
...
ACTIVE
BEFORE INSERT
external name 'esp.TestTrigger.do_not_evaluate_field_test1_insert()'
engine JAVA;
commit;
...
ACTIVE
AFTER INSERT
external name 'esp.TestTrigger.do_not_evaluate_field_test2_test4_insert()'
engine JAVA;
commit;
...
ACTIVE
BEFORE INSERT
external name 'esp.TestTrigger.evaluate_field_test1_insert()'
engine JAVA;
commit;
...
ACTIVE
AFTER INSERT
external name 'esp.TestTrigger.evaluate_field_test2_test4_insert()'
engine JAVA;
commit;
...
ACTIVE
BEFORE INSERT
external name 'esp.TestTrigger.do_not_evaluate_computed_fields_insert()'
engine JAVA;
commit;
...
ACTIVE
AFTER INSERT
external name 'esp.TestTrigger.do_not_evaluate_field_test2_do_not_evaluate_computed_fields_insert()'
engine JAVA;
commit;
