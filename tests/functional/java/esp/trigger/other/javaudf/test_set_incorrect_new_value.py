...
"""
ID:          java.esp.trigger.other.javaudf.set-incorrect-new-value
TITLE:       Set incorrect new value from BEFORE UPDATE trigger
DESCRIPTION: 
FBTEST:      functional.java.esp.trigger.other.javaudf.set_incorrect_new_value
"""
...
ACTIVE
BEFORE UPDATE
external name 'esp.TestTrigger.setNewValue_jespudfcompat_incorrect_value()'
engine JAVA;
commit;
