...
"""
ID:          java.esp.trigger.context.view-before
TITLE:       Get context of ddl trigger on BEFORE CREATE, ALTER, DROP VIEW
DESCRIPTION: 
FBTEST:      functional.java.esp.trigger.context.view_before
"""
...
ACTIVE
BEFORE CREATE VIEW or ALTER VIEW or DROP VIEW
