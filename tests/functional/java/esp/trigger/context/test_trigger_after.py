...
"""
ID:          java.esp.trigger.context.trigger-after
TITLE:       Get context of ddl trigger on AFTER CREATE, ALTER, DROP TRIGGER
DESCRIPTION: 
FBTEST:      functional.java.esp.trigger.context.trigger_after
"""
...
ACTIVE
AFTER CREATE TRIGGER or ALTER TRIGGER or DROP TRIGGER
