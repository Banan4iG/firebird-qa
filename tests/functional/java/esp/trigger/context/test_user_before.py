...
"""
ID:          java.esp.trigger.context.user-before
TITLE:       Get context of ddl trigger on BEFORE CREATE, ALTER, DROP USER
DESCRIPTION: 
FBTEST:      functional.java.esp.trigger.context.user_before
"""
