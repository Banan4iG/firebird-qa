...
"""
ID:          java.esp.trigger.context.index-before
TITLE:       Get context of ddl trigger on BEFORE CREATE, ALTER, DROP INDEX
DESCRIPTION: 
FBTEST:      functional.java.esp.trigger.context.index_before
"""
...
ACTIVE
BEFORE CREATE INDEX or ALTER INDEX or DROP INDEX
