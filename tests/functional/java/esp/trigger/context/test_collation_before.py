...
"""
ID:          java.esp.trigger.context.collation-before
TITLE:       Get context of ddl trigger on BEFORE CREATE, DROP COLLATION
DESCRIPTION: 
FBTEST:      functional.java.esp.trigger.context.collation_before
"""
...
ACTIVE
BEFORE CREATE COLLATION or DROP COLLATION
