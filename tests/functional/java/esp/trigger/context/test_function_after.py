...
"""
ID:          java.esp.trigger.context.function-after
TITLE:       Get context of ddl trigger on AFTER CREATE, ALTER, DROP FUNCTION
DESCRIPTION: 
FBTEST:      functional.java.esp.trigger.context.function_after
"""
...
ACTIVE
AFTER CREATE FUNCTION or ALTER FUNCTION or DROP FUNCTION
