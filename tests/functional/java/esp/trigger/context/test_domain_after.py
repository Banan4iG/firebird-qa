...
"""
ID:          java.esp.trigger.context.domain-after
TITLE:       Get context of ddl trigger on AFTER CREATE, ALTER, DROP DOMAIN
DESCRIPTION: 
FBTEST:      functional.java.esp.trigger.context.domain_after
"""
...
ACTIVE
AFTER CREATE DOMAIN or ALTER DOMAIN or DROP DOMAIN
