...
"""
ID:          java.esp.trigger.context.mapping-after
TITLE:       Get context of ddl trigger on AFTER CREATE, ALTER, DROP MAPPING
DESCRIPTION: 
FBTEST:      functional.java.esp.trigger.context.mapping_after
"""
...
ACTIVE
AFTER CREATE MAPPING or ALTER MAPPING or DROP MAPPING
