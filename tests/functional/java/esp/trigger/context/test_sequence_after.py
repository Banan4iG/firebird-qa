...
"""
ID:          java.esp.trigger.context.sequence-after
TITLE:       Get context of ddl trigger on AFTER CREATE, ALTER, DROP SEQUENCE
DESCRIPTION: 
FBTEST:      functional.java.esp.trigger.context.sequence_after
"""
...
ACTIVE
AFTER CREATE SEQUENCE or ALTER SEQUENCE or DROP SEQUENCE
