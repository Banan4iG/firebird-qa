...
"""
ID:          java.esp.trigger.context.table-after
TITLE:       Get context of ddl trigger on AFTER CREATE, ALTER, DROP TABLE
DESCRIPTION: 
FBTEST:      functional.java.esp.trigger.context.table_after
"""
