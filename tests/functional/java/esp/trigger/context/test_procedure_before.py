...
"""
ID:          java.esp.trigger.context.procedure-before
TITLE:       Get context of ddl trigger on BEFORE CREATE, ALTER, DROP PROCEDURE
DESCRIPTION: 
FBTEST:      functional.java.esp.trigger.context.procedure_before
"""
...
ACTIVE
BEFORE CREATE PROCEDURE or ALTER PROCEDURE or DROP PROCEDURE
