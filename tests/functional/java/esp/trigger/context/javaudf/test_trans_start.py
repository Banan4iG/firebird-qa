...
"""
ID:          java.esp.trigger.context.javaudf.trans-start
TITLE:       Get context of TRANSACTION START trigger
DESCRIPTION: 
FBTEST:      functional.java.esp.trigger.context.javaudf.trans_start
"""
