...
"""
ID:          java.esp.trigger.context.javaudf.any-ddl-statement-before
TITLE:       Get context of ddl trigger on BEFORE ANY DDl STATEMENT
DESCRIPTION: 
FBTEST:      functional.java.esp.trigger.context.javaudf.any_ddl_statement_before
"""
