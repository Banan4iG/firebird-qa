...
"""
ID:          java.esp.trigger.context.character-set-before
TITLE:       Get context of ddl trigger on BEFORE ALTER CHARACTER SET
DESCRIPTION: 
FBTEST:      functional.java.esp.trigger.context.character_set_before
"""
