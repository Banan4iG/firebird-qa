...
"""
ID:          java.esp.trigger.context.connect
TITLE:       Get context of CONNECT trigger
DESCRIPTION: 
FBTEST:      functional.java.esp.trigger.context.connect
"""
...
ON CONNECT
external name 'esp.TestTrigger.getContext()!connection'
engine JAVA;
commit;
...
Table name:
Type: DATABASE
Info stored at entry point metadata: connection
