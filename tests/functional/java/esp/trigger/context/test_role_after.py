...
"""
ID:          java.esp.trigger.context.role-after
TITLE:       Get context of ddl trigger on AFTER CREATE, ALTER, DROP ROLE
DESCRIPTION: 
FBTEST:      functional.java.esp.trigger.context.role_after
"""
...
ACTIVE
AFTER CREATE ROLE or ALTER ROLE or DROP ROLE
