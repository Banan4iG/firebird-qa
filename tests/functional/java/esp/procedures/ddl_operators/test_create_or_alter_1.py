...
"""
ID:          java.esp.procedures.ddl-operators.create-or-alter-1
TITLE:       Testing CREATE OR ALTER operator for external procedure when procedure is created
DESCRIPTION: 
FBTEST:      functional.java.esp.procedures.ddl_operators.create_or_alter_1
"""
