...
"""
ID:          java.esp.procedures.type-compability.lang-integer
TITLE:       External procedure call with java.lang.Integer  type of input parameter
DESCRIPTION: 
  External procedure is declared with SQL types compatible with java.lang.Integer Java type. Parameter as a constant.
FBTEST:      functional.java.esp.procedures.type_compability.lang_integer
"""
