...
"""
ID:          java.esp.procedures.type-compability.float
TITLE:       External procedure call with float type of input parameter
DESCRIPTION: 
  External procedure is declared with SQL types compatible with float Java type. Parameter as a constant.
FBTEST:      functional.java.esp.procedures.type_compability.float
"""
...
act = isql_act('db', test_script, substitutions=[('0.00000000', '0.0000000')])
