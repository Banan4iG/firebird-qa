...
"""
ID:          java.esp.procedures.type-compability.double
TITLE:       External procedure call with double type of input parameter
DESCRIPTION: 
  External procedure is declared with SQL types compatible with double Java type. Parameter as a constant.
FBTEST:      functional.java.esp.procedures.type_compability.double
"""
