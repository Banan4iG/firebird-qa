...
"""
ID:          java.esp.procedures.type-compability.lang-float
TITLE:       External procedure call with java.lang.Float  type of input parameter
DESCRIPTION: 
  External procedure is declared with SQL types compatible with java.lang.Float Java type. Parameter as a constant.
FBTEST:      functional.java.esp.procedures.type_compability.lang_float
"""
