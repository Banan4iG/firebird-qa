...
"""
ID:          java.esp.procedures.type-compability.long
TITLE:       External procedure call with long type of input parameter
DESCRIPTION: 
  External procedure is declared with SQL types compatible with long Java type. Parameter as a constant.
FBTEST:      functional.java.esp.procedures.type_compability.long
"""
