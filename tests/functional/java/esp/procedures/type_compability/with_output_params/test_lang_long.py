...
"""
ID:          java.esp.procedures.type-compability.with-output-params.lang-long
TITLE:       External procedure call with java.lang.Long  type of input and output parameters
DESCRIPTION: 
  External procedure is declared with SQL types compatible with java.lang.Long Java type. Parameter as a constant.
FBTEST:      functional.java.esp.procedures.type_compability.with_output_params.lang_long
"""
...
returns(o SMALLINT)
external name 'esp.TestProcedure.LongInOut(Long, Long[])'
engine java;
commit;
