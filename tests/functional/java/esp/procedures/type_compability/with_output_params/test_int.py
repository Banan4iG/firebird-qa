...
"""
ID:          java.esp.procedures.type-compability.with-output-params.int
TITLE:       External procedure call with int type of input and output parameter
DESCRIPTION: 
  External procedure is declared with SQL types compatible with int Java type. Parameter as a constant.
FBTEST:      functional.java.esp.procedures.type_compability.with_output_params.int
"""
...
returns(o SMALLINT)
external name 'esp.TestProcedure.intInOut(int, int[])'
engine java;
commit;
