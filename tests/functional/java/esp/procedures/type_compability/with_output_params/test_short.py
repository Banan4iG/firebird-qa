...
"""
ID:          java.esp.procedures.type-compability.with-output-params.short
TITLE:       External procedure call with short type of input and output parameters
DESCRIPTION: 
  External procedure is declared with SQL types compatible with short Java type. Parameter as a constant.
FBTEST:      functional.java.esp.procedures.type_compability.with_output_params.short
"""
