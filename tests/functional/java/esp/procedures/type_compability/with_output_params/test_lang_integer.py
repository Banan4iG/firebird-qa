...
"""
ID:          java.esp.procedures.type-compability.with-output-params.lang-integer
TITLE:       External procedure call with java.lang.Integer  type of input and output parameters
DESCRIPTION: 
  External procedure is declared with SQL types compatible with java.lang.Integer Java type. Parameter as a constant.
FBTEST:      functional.java.esp.procedures.type_compability.with_output_params.lang_integer
"""
...
returns(o SMALLINT)
external name 'esp.TestProcedure.IntegerInOut(Integer, Integer[])'
engine java;
commit;
