...
"""
ID:          java.esp.procedures.type-compability.with-output-params.lang-short
TITLE:       External procedure call with java.lang.Short  type of input and output parameters
DESCRIPTION: 
  External procedure is declared with SQL types compatible with java.lang.Short Java type. Parameter as a constant.
FBTEST:      functional.java.esp.procedures.type_compability.with_output_params.lang_short
"""
...
returns(o SMALLINT)
external name 'esp.TestProcedure.ShortInOut(Short, Short[])'
engine java;
commit;
