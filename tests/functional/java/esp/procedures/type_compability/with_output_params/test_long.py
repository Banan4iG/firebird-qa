...
"""
ID:          java.esp.procedures.type-compability.with-output-params.long
TITLE:       External procedure call with long type of input and output parameters
DESCRIPTION: 
  External procedure is declared with SQL types compatible with long Java type. Parameter as a constant.
FBTEST:      functional.java.esp.procedures.type_compability.with_output_params.long
"""
