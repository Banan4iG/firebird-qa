...
"""
ID:          java.esp.procedures.type-compability.with-output-params.float
TITLE:       External procedure call with float type of input and output parameters
DESCRIPTION: 
  External procedure is declared with SQL types compatible with float Java type. Parameter as a constant.
FBTEST:      functional.java.esp.procedures.type_compability.with_output_params.float
"""

import pytest
from firebird.qa import *

substitutions = [('0\\.00000000(0)+', '0.000000000000000'), ('0\\.0000000(0)*', '0.00000000')]
