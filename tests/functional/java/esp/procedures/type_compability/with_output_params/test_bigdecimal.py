...
"""
ID:          java.esp.procedures.type-compability.with-output-params.bigdecimal
TITLE:       External function call with java.math.BigDecimal type of input and output parameters
DESCRIPTION: 
  External function is declared with SQL types compatible with java.math.BigDecimal Java type. Parameter as a constant.
FBTEST:      functional.java.esp.procedures.type_compability.with_output_params.bigdecimal
"""
...
returns(o SMALLINT)
external name 'esp.TestProcedure.bigDecimalInOut(java.math.BigDecimal, java.math.BigDecimal[])'
engine java;
commit;
