...
"""
ID:          java.esp.procedures.type-compability.boolean
TITLE:       External procedure call with boolean type of input parameter
DESCRIPTION: 
  External procedure is declared with SQL types compatible with boolean Java type. Parameter as a constant.
FBTEST:      functional.java.esp.procedures.type_compability.boolean
"""
