...
"""
ID:          java.esp.procedures.type-compability.short
TITLE:       External procedure call with short type of input parameter
DESCRIPTION: 
  External procedure is declared with SQL types compatible with short Java type. Parameter as a constant.
FBTEST:      functional.java.esp.procedures.type_compability.short
"""
