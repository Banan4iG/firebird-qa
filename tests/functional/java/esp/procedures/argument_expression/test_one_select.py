...
"""
ID:          java.esp.procedures.argument-expression.one-select
TITLE:       External procedure call with input parameter as a selection of one
DESCRIPTION: 
FBTEST:      functional.java.esp.procedures.argument_expression.one_select
"""
...
EXECUTE PROCEDURE test_1((select number from help_table where id=1));
EXECUTE PROCEDURE test_2((select number from help_table where id=2));
EXECUTE PROCEDURE test_3((select number from help_table where id=1));
EXECUTE PROCEDURE test_4((select number from help_table where id=2));
EXECUTE PROCEDURE test_5((select number from help_table where id=1));
EXECUTE PROCEDURE test_6((select number from help_table where id=2));
EXECUTE PROCEDURE test_7((select number from help_table where id=1));
EXECUTE PROCEDURE test_8((select number from help_table where id=2));
EXECUTE PROCEDURE test_9((select number from help_table where id=1));
EXECUTE PROCEDURE test_10((select number from help_table where id=2));
EXECUTE PROCEDURE test_11((select number from help_table where id=1));
EXECUTE PROCEDURE test_12((select name from help_table where id=2));
EXECUTE PROCEDURE test_13((select name from help_table where id=1));
EXECUTE PROCEDURE test_14((select name from help_table where id=2));
EXECUTE PROCEDURE test_15((select name from help_table where id=1));
EXECUTE PROCEDURE test_16((select name from help_table where id=2));
EXECUTE PROCEDURE test_17((select d from help_table where id=1));
EXECUTE PROCEDURE test_18((select t from help_table where id=2));
EXECUTE PROCEDURE test_19((select ts from help_table where id=1));
EXECUTE PROCEDURE test_20((select d from help_table where id=2));
EXECUTE PROCEDURE test_21((select flag from help_table where id=1));
EXECUTE PROCEDURE test_22((select flag from help_table where id=2));
commit;
