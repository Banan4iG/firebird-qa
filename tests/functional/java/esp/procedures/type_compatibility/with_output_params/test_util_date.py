...
"""
ID:          java.esp.procedures.type-compatibility.with-output-params.util-date
TITLE:       External function call with java.util.Date  type of input and output parameters
DESCRIPTION: 
  External function is declared with SQL types compatible with java.util.Date Java type. Parameter as a constant.
FBTEST:      functional.java.esp.procedures.type_compatibility.with_output_params.util_date
"""
...
returns(o CHAR(15))
external name 'esp.TestProcedure.util_dateInOut(java.util.Date, java.util.Date[])'
engine java;
commit;
