...
"""
ID:          java.esp.procedures.type-compatibility.with-output-params.lang-string
TITLE:       External function call with java.lang.String type of input and output parameters
DESCRIPTION: 
  External function is declared with SQL types compatible with java.lang.String Java type. Parameter as a constant.
FBTEST:      functional.java.esp.procedures.type_compatibility.with_output_params.lang_string
"""
...
returns(o INTEGER)
external name 'esp.TestProcedure.StringInOut(String, String[])' 
engine java;
commit;
