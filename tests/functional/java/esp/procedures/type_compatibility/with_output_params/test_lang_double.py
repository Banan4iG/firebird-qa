...
"""
ID:          java.esp.procedures.type-compatibility.with-output-params.lang-double
TITLE:       External procedure call with java.lang.Double  type of input and output parameter
DESCRIPTION: 
  External procedure is declared with SQL types compatible with java.lang.Double Java type. Parameter as a constant.
FBTEST:      functional.java.esp.procedures.type_compatibility.with_output_params.lang_double
"""
