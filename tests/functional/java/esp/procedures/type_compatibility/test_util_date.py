...
"""
ID:          java.esp.procedures.type-compatibility.util-date
TITLE:       External function call with java.util.Date  type of input parameter
DESCRIPTION: 
  External function is declared with SQL types compatible with java.util.Date Java type. Parameter as a constant.
FBTEST:      functional.java.esp.procedures.type_compatibility.util_date
"""
