...
"""
ID:          java.esp.procedures.type-compatibility.lang-object
TITLE:       External function call with java.lang.Object type of input parameter
DESCRIPTION: 
  External function is declared with SQL types compatible with java.lang.Object Java type. Parameter as a constant.
FBTEST:      functional.java.esp.procedures.type_compatibility.lang_object
"""
...
init_script = """
CREATE TABLE TEST_TABLE(F VARCHAR(40));
commit;
