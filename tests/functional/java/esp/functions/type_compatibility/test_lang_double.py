...
"""
ID:          java.esp.functions.type-compatibility.lang-double
TITLE:       External function call with java.lang.Double type of result and input parameter
DESCRIPTION: 
  External function is declared with SQL types compatible with java.lang.Double Java type. Parameter as a constant.
FBTEST:      functional.java.esp.functions.type_compatibility.lang_double
"""
...
SELECT cast(TEST_10('5') as varchar(20)) as "TEST_10" FROM RDB$DATABASE;
SELECT cast(TEST_10('-5.55') as varchar(20)) as "TEST_10" FROM RDB$DATABASE;
SELECT cast(TEST_10('14.35') as varchar(20)) as "TEST_10" FROM RDB$DATABASE;
SELECT cast(TEST_10(null) as varchar(20)) as "TEST_10" FROM RDB$DATABASE;
"""
