...
"""
ID:          java.esp.functions.type-compatibility.lang-string
TITLE:       External function call with java.lang.String type of result and input parameter
DESCRIPTION: 
  External function is declared with SQL types compatible with java.lang.String Java type. Parameter as a constant.
FBTEST:      functional.java.esp.functions.type_compatibility.lang_string
"""
