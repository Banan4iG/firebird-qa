...
"""
ID:          java.esp.functions.type-compatibility.double
TITLE:       External function call with double type of result and input parameter
DESCRIPTION: 
  External function is declared with SQL types compatible with double Java type. Parameter as a constant.
FBTEST:      functional.java.esp.functions.type_compatibility.double
"""
