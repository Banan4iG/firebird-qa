...
"""
ID:          java.esp.functions.type-compatibility.int
TITLE:       External function call with int type of result and input parameter
DESCRIPTION: 
  External function is declared with SQL types compatible with int Java type. Parameter as a constant.
FBTEST:      functional.java.esp.functions.type_compatibility.int
"""
