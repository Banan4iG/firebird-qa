...
"""
ID:          java.esp.functions.type-compatibility.short
TITLE:       External function call with short type of result and input parameter
DESCRIPTION: 
  External function is declared with SQL types compatible with short Java type. Parameter as a constant.
FBTEST:      functional.java.esp.functions.type_compatibility.short
"""
