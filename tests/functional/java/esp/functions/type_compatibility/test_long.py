...
"""
ID:          java.esp.functions.type-compatibility.long
TITLE:       External function call with long type of result and input parameter
DESCRIPTION: 
  External function is declared with SQL types compatible with long Java type. Parameter as a constant.
FBTEST:      functional.java.esp.functions.type_compatibility.long
"""
...
init_script = """
create function test_1(i BIGINT) 
returns BIGINT 
