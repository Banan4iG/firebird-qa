...
"""
ID:          java.esp.functions.without-parameters.float-result
TITLE:       External function call with float type of result and without input parameter
DESCRIPTION: 
  External function is declared with SQL types compatible with float Java type.
FBTEST:      functional.java.esp.functions.without_parameters.float_result
"""
