...
"""
ID:          java.esp.functions.without-parameters.long-result
TITLE:       External function call with long type of result and without input parameter
DESCRIPTION: 
  External function is declared with SQL types compatible with long Java type.
FBTEST:      functional.java.esp.functions.without_parameters.long_result
"""
