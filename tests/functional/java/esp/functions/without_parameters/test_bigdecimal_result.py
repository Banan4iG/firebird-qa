...
"""
ID:          java.esp.functions.without-parameters.bigdecimal-result
TITLE:       External function call with java.math.BigDecimal type of result and without input parameter
DESCRIPTION: 
  External function is declared with SQL types compatible with java.math.BigDecimal Java type.
FBTEST:      functional.java.esp.functions.without_parameters.bigdecimal_result
"""
...
returns smallint
external name 'esp.TestFunction.bigDecimalOut()'
engine java;
commit;
