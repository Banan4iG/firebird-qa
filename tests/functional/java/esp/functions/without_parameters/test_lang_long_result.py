...
"""
ID:          java.esp.functions.without-parameters.lang-long-result
TITLE:       External function call with java.lang.Long type of result and without input parameter
DESCRIPTION: 
  External function is declared with SQL types compatible with java.lang.Long Java type.
FBTEST:      functional.java.esp.functions.without_parameters.lang_long_result
"""
...
returns smallint
external name 'esp.TestFunction.LongOut()'
engine java;
commit;
