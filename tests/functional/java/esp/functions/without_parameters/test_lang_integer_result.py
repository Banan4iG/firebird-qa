...
"""
ID:          java.esp.functions.without-parameters.lang-integer-result
TITLE:       External function call with java.lang.Integer type of result and without input parameter
DESCRIPTION: 
  External function is declared with SQL types compatible with java.lang.Integer Java type.
FBTEST:      functional.java.esp.functions.without_parameters.lang_integer_result
"""
...
returns smallint
external name 'esp.TestFunction.integerOut()'
engine java;
commit;
