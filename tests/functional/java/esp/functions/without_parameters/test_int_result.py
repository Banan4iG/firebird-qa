...
"""
ID:          java.esp.functions.without-parameters.int-result
TITLE:       External function call with int type of result and without input parameter
DESCRIPTION: 
  External function is declared with SQL types compatible with int Java type.
FBTEST:      functional.java.esp.functions.without_parameters.int_result
"""
...
returns INTEGER
external name 'esp.TestFunction.intOut()' 
engine java;
commit;
