...
"""
ID:          java.esp.functions.without-parameters.lang-double-result
TITLE:       External function call with java.lang.Double type of result and without input parameter
DESCRIPTION: 
  External function is declared with SQL types compatible with java.lang.Double Java type.
FBTEST:      functional.java.esp.functions.without_parameters.lang_double_result
"""
