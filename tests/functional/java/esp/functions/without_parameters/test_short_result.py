...
"""
ID:          java.esp.functions.without-parameters.short-result
TITLE:       External function call with short type of result and without input parameter
DESCRIPTION: 
  External function is declared with SQL types compatible with short Java type.
FBTEST:      functional.java.esp.functions.without_parameters.short_result
"""
