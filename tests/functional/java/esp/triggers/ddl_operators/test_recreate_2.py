...
"""
ID:          java.esp.triggers.ddl-operators.recreate-2
TITLE:       Testing RECREATE operator for external trigger when trigger is created
DESCRIPTION: 
FBTEST:      functional.java.esp.triggers.ddl_operators.recreate_2
"""
