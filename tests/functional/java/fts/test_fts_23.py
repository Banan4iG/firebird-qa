...
FBTEST:      functional.java.fts.fts_23
"""
...
======================= =============================== ===============================================================================
1.456889748573303 TABLE1                          <B>fts_test_text</B>
"""
...
# commit;
# SELECT fts$score, fts$relation, FTS$HIGHLIGHT from FTS$SEARCH('TEST_INDEX', NULL, 'fts_test_texts~', 20);
...
======================= =============================== ================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================
3.205157518386841 TABLE1                          <B>fts_test_text</B>
"""
...
# EXECUTE PROCEDURE FTS$REINDEX('TEST_INDEX');
# commit;
# SELECT fts$relation, FTS$HIGHLIGHT from FTS$SEARCH('TEST_INDEX', NULL, 'fts_test_texts~', 20);
# EXECUTE PROCEDURE FTS$DROP_INDEX('TEST_INDEX');
# commit;
# DELETE FROM TABLE1 WHERE F_VCHAR = 'fts_test_text';
# COMMIT;
