...
DESCRIPTION: 
  ...
  Search on a two fields in a one table.
  Search with reindex execute.
FBTEST:      functional.java.fts.fts_03
"""
...
======================= =============================== ===============================================================================
1.726938724517822 TABLE1                          <B>fts_test_text</B>
1.726938724517822 TABLE1                          <B>fts_test_text</B>
"""
...
# commit;
# INSERT INTO TABLE1(F_VCHAR, F_CHAR) VALUES('fts_test_text', '1');
# COMMIT;
# INSERT INTO TABLE1(F_CHAR, F_VCHAR) VALUES('fts_test_text', '1');
# COMMIT;
...
======================= =============================== ================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================
3.799265384674072 TABLE1                          <B>fts_test_text</B>
3.799265384674072 TABLE1                          <B>fts_test_text</B>
"""
