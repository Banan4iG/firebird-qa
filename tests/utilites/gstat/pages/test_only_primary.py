#coding:utf-8
"""
ID:          utilites.gstat.pages.only_primary
TITLE:       Check user tables data page metrics for table with only primary pages. 
DESCRIPTION: Check following data pages metrics:
             - Pointer pages
             - Data page slots
             - Data pages
             - Average fill
