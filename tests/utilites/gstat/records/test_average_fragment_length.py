#coding:utf-8
"""
ID:          utilites.gstat.records.average_fragment_length
TITLE:       Check user tables average fragment length statistics. 
DESCRIPTION: 
...
TEST_METRIC = 'Average fragment length'
