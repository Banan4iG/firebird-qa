#coding:utf-8
"""
ID:          utilites.gstat.record.total_records
...
def test_many_records(act2: Action, gstat_helpers):       
    ...
    records = gstat_helpers.get_stat(act2.stdout, 'SMALL', TEST_METRIC)
    assert records == SMALL_REC_QNT
    records = gstat_helpers.get_stat(act2.stdout, 'LARGE', TEST_METRIC)
